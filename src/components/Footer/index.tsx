    ...
    <>
      <footer className="relative z-10 bg-white pt-16 dark:bg-gray-dark md:pt-20 lg:pt-24">
        <div className="container">
            ...
            <div className="w-full px-4 md:w-1/2 lg:w-2/12 xl:w-3/12">
              <div className="mb-12 max-w-[360px] lg:mb-16">
                ...
                <p className="mb-9 text-base leading-relaxed text-body-color dark:text-body-color-dark">
                  IN SERVICE OF MUSIC SINCE 1969
                </p>
          ...
          <div className="h-px w-full bg-gradient-to-r from-transparent via-[#ffc300] to-transparent dark:via-[#ffc300]"></div>
          <div className="py-8">
        ...
        <div className="absolute right-0 top-14 z-[-1]">
          <svg
            ...
            xmlns="http://www.w3.org/2000/svg"
          >
            <circle opacity="0.8" cx="49.5" cy="49.5" r="49.5" fill="#ffc300" />
            <mask
              id="mask0_94:899"
          ...
          >
            ...
            <defs>
              <linearGradient
                ...
                gradientUnits="userSpaceOnUse"
              >
                <stop stopColor="#ffc300" stopOpacity="0.62" />
              ...
              <linearGradient
                ...
                gradientUnits="userSpaceOnUse"
              >
                <stop stopColor="#ffc300" stopOpacity="0" />
                <stop offset="1" stopColor="#ffc300" stopOpacity="0.51" />
              </linearGradient>
              <linearGradient
